...
import { closeDialogById } from "~/components/ui/dialog/utils";
import {
  brandClassName,
  mobileNavButtonClassName,
  mobileNavDialogShellClassName,
...
const withDialogClose =
  ...
  (event: MouseEvent<HTMLAnchorElement>) => {
    closeDialogById(MOBILE_NAV_DIALOG_ID);
    onClick?.(event);
  };
...
const MobileNavDialog = ({ auth }: MobileNavDialogProps) => (
  <Dialog
    ...
    variant="fullscreen"
  >
    <div className={cx(navShellClassName, mobileNavDialogShellClassName)}>
      <div className={cx(brandClassName, navBrandClassName)}>
        <CustomLink onClick={closeBrandLink} to={href("/")}>
          #vanlife
        </CustomLink>
      </div>
