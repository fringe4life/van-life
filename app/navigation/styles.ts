...
export const navShellClassName = css({
  ...
  gridTemplateColumns: {
    ...
    nav: "minmax(0, 1fr) auto minmax(0, 1fr)",
  },
  inlineSize: "100%",
  minInlineSize: "0",
  paddingBlock: "7",
...
export const navBrandClassName = css({
  ...
  minInlineSize: "0",
  overflow: "hidden",
  paddingInlineStart: { base: "6", nav: "0" },
  textOverflow: "ellipsis",
  whiteSpace: "nowrap",
});

export const mobileNavDialogShellClassName = css({
  inlineSize: "calc(100% - (2 * {spacing.padding-inline}))",
  marginInline: "auto",
});

export const desktopPageNavClassName = css({
  display: { base: "none", nav: "block" },
  inlineSize: "100%",
  justifySelf: "center",
  maxInlineSize: "100%",
  minInlineSize: "0",
...
export const navEndClusterClassName = hstack({
  gap: { base: "1", nav: "3" },
  justifyContent: { nav: "end" },
  justifySelf: { nav: "end" },
  minInlineSize: "0",
});
...
export const mobileNavButtonClassName = css({
  ...
  cursor: "pointer",
  display: { base: "inline-flex", nav: "none" },
