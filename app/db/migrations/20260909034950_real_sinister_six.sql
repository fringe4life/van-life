-- Better Auth 1.7.3: drop issuer unique + column. Identity unique is (provider_id, account_id).
...
CREATE TABLE `__new_account` (
	...
	CONSTRAINT `account_providerId_accountId_uidx` UNIQUE(`provider_id`,`account_id`)
);
