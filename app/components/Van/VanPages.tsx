...
import Pagination, { type PaginationPropsForVanPages } from '~/components/Pagination';
...
} & GenericComponentProps<T, P> & PaginationPropsForVanPages;
...
export default function VanPages<P, T, U>(props: VanPagesProps<T, P, U>) {
	...
	return (
		...
		>
			...
			{optionalElement}
			<GenericComponent className="grid-max grid-max-medium mt-6" {...rest} />
